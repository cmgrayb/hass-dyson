...
class TestDysonDataUpdateCoordinatorDeviceInfoExtraction:
    ...
    @pytest.mark.asyncio
    async def test_extract_device_type_with_product_type(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_extract_device_type_with_type_field(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_extract_device_type_missing_both_fields(self, mock_hass, mock_config_entry):
    ...
    async def test_extract_device_category_from_config(self, mock_hass):
        ...
        with patch("custom_components.hass_dyson.device_utils.normalize_device_category") as mock_normalize:
    ...
    async def test_extract_device_capabilities_from_config(self, mock_hass):
        ...
        with patch("custom_components.hass_dyson.device_utils.normalize_capabilities") as mock_normalize:
    ...
    @pytest.mark.asyncio
    async def test_extract_device_capabilities_from_api(self, mock_hass, mock_config_entry):
        ...
        with patch.object(coordinator, "_extract_capabilities") as mock_extract_caps:
            with patch("custom_components.hass_dyson.device_utils.normalize_capabilities") as mock_normalize:
                ...
                assert coordinator.device_capabilities == ["environmental_data", "air_quality"]
                mock_extract_caps.assert_called_once_with(mock_device_info)
                mock_normalize.assert_called_once_with(["environmental_data", "air_quality"])

    @pytest.mark.asyncio
    async def test_extract_device_capabilities_api_exception(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_extract_device_capabilities_critical_exception(self, mock_hass, mock_config_entry):
...
class TestDysonDataUpdateCoordinatorMQTTCredentials:
    ...
    @pytest.mark.asyncio
    async def test_get_mqtt_object_no_connected_config(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_get_mqtt_username_with_username_field(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_get_mqtt_username_fallback_to_serial(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_get_plain_password_with_password_field(self, mock_hass, mock_config_entry):
    ...
    async def test_decrypt_mqtt_credentials_success(self, mock_hass, mock_config_entry):
        ...
        mock_cloud_client.decrypt_local_credentials.assert_called_once_with("encrypted_credentials", "VS6-EU-HJA1234A")

    @pytest.mark.asyncio
    async def test_decrypt_mqtt_credentials_no_credentials(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_decrypt_mqtt_credentials_exception(self, mock_hass, mock_config_entry):
        """Test MQTT credentials decryption with exception."""
        with patch("custom_components.hass_dyson.coordinator.DataUpdateCoordinator.__init__"):
            coordinator = DysonDataUpdateCoordinator(mock_hass, mock_config_entry)

        mock_cloud_client = MagicMock()
        mock_cloud_client.decrypt_local_credentials.side_effect = Exception("Decryption failed")
    ...
    async def test_extract_mqtt_credentials_success(self, mock_hass, mock_config_entry):
        ...
        with patch.object(coordinator, "_get_mqtt_object") as mock_get_mqtt_obj:
            with patch.object(coordinator, "_get_mqtt_username") as mock_get_username:
                with patch.object(coordinator, "_get_mqtt_password") as mock_get_password:
                    mock_mqtt_obj = MagicMock()
                    ...
                    result = await coordinator._extract_mqtt_credentials(mock_cloud_client, mock_device_info)
    ...
    @pytest.mark.asyncio
    async def test_extract_mqtt_credentials_empty_password(self, mock_hass, mock_config_entry):
            ...
            with patch.object(coordinator, "_get_mqtt_username") as mock_get_username:
                with patch.object(coordinator, "_get_mqtt_password") as mock_get_password:
                    ...
                    with pytest.raises(UpdateFailed, match="MQTT password cannot be empty"):
                        await coordinator._extract_mqtt_credentials(mock_cloud_client, mock_device_info)
...
class TestDysonDataUpdateCoordinatorUpdate:
    ...
    @pytest.mark.asyncio
    async def test_async_update_data_device_connected(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_async_update_data_device_reconnection_success(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_async_update_data_device_reconnection_failure(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_async_update_data_send_command_exception(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_update_coordinator_data_exception(self, mock_hass, mock_config_entry):
...
class TestDysonDataUpdateCoordinatorDebugMethods:
    ...
    @pytest.mark.asyncio
    async def test_debug_connected_configuration_with_config(self, mock_hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_debug_connected_configuration_none(self, mock_hass, mock_config_entry):
    ...
    async def test_debug_mqtt_object_with_mqtt(self, mock_hass, mock_config_entry):
        ...
        # Use simpler mock setup to avoid complex nesting
        mock_mqtt_obj = MagicMock()
        mock_mqtt_obj.configure_mock(**{"password": "test_password", "decoded_password": "decoded_password"})
    ...
    @pytest.mark.asyncio
    async def test_log_mqtt_credentials_short_password(self, mock_hass, mock_config_entry):
