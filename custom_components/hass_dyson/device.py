...
class DysonDevice:
    ...
    def _on_connect(self, client: mqtt.Client, userdata: Any, flags, rc, properties=None, *args) -> None:
    ...
    def _on_disconnect(self, client: mqtt.Client, userdata: Any, rc, properties=None, *args) -> None:
